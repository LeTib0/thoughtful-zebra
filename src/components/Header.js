            	...
            	<div className="container">
            		<nav className="navbar flex items-center" aria-label="Main Navigation">
            			...
            			<div className="navbar__branding mr-2">
            				...
            				<Link className="navbar__logo m-0" to={withPrefix('/')}><img width="150" src={withPrefix(_.get(this.props, 'pageContext.site.siteMetadata.header.logo', null))} alt={_.get(this.props, 'pageContext.site.siteMetadata.header.logo_alt', null)} /></Link>
            				) : 
